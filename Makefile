...
test-sim-import-export: runsim
	...
	@$(BINDIR)/runsim -Jobs=4 -APP_DIRPkg=$(APP_DIR) -ExitOnFail 50 5 TestAppImportExport

test-sim-after-import: runsim
	@echo "Running application simulation-after-import. This may take several minutes..."
	@$(BINDIR)/runsim -Jobs=4 -APP_DIRPkg=$(APP_DIR) -ExitOnFail 50 5 TestAppSimulationAfterImport

test-sim-custom-genesis-multi-seed: runsim
	@echo "Running multi-seed custom genesis simulation..."
	@echo "By default, ${HOME}/.bitsongd/config/genesis.json will be used."
	@$(BINDIR)/runsim -Genesis=${HOME}/.bitsongd/config/genesis.json -APP_DIRPkg=$(APP_DIR) -ExitOnFail 400 5 TestFullAppSimulation

test-sim-multi-seed-long: runsim
	@echo "Running long multi-seed application simulation. This may take awhile!"
	@$(BINDIR)/runsim -Jobs=4 -APP_DIRPkg=$(APP_DIR) -ExitOnFail 500 50 TestFullAppSimulation

test-sim-multi-seed-short: runsim
	@echo "Running short multi-seed application simulation. This may take awhile!"
	@$(BINDIR)/runsim -Jobs=4 -APP_DIRPkg=$(APP_DIR) -ExitOnFail 50 10 TestFullAppSimulation
