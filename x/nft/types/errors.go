...
var (
	...
	ErrInvalidSplitShares   = sdkerrors.Register(ModuleName, 13, "invalid split shares")
	ErrInvalidRoyaltyShares = sdkerrors.Register(ModuleName, 14, "invalid royalty shares")
)
