...
import (
	...
	"github.com/bitsongofficial/chainmodules/x/auction/simulation"
...
func NewAppModule(cdc codec.Marshaler, keeper keeper.Keeper, ak types.AccountKeeper, bk types.BankKeeper, nk types.NftKeeper) AppModule {
	return AppModule{
